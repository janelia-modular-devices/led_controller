...
void Controller::setup()
{
  ...
  set_channel_power_method.attachCallback(callbacks::setChannelOnCallback);
...
void Controller::enableChannel(int channel)
{
  digitalWrite(constants::enable_pins[channel],HIGH);
}

void Controller::disableChannel(int channel)
{
  digitalWrite(constants::enable_pins[channel],LOW);
}

void Controller::setChannelPower(int channel, int power)
{
